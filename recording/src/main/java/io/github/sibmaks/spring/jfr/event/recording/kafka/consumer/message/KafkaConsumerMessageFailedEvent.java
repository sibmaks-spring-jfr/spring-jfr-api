...
import io.github.sibmaks.spring.jfr.event.reading.api.kafka.consumer.message.KafkaConsumerMessageFailedRecordedEvent;
...
@RecordedEventType(KafkaConsumerMessageFailedRecordedEvent.class)
