...
import io.github.sibmaks.spring.jfr.event.reading.api.kafka.consumer.topic.KafkaConsumerTopicsUnsubscribedRecordedEvent;
...
@RecordedEventType(KafkaConsumerTopicsUnsubscribedRecordedEvent.class)
